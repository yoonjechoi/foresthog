      ...
      <div className={styles.whiteBox}>
        {props.action == "login" && (
          <p className={styles.text}>
            Don't have an account? <span className={styles.changeLink} onClick={props.changeAction}>Sign up</span>
          </p>
        )}

        {props.action == "signup" && (
          <p className={styles.text}>
            Have an account? <span className={styles.changeLink} onClick={props.changeAction}>Log in</span>
          </p>
        )}
      </div>
