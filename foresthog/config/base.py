"""
Django settings for foresthog project.
...
SECRET_KEY = 'b3$a-10+r9^g-sewfh(&k_)*wwb($q$y^&f=9ca+n8qc!f@b8h'
...
WSGI_APPLICATION = 'foresthog.wsgi.application'
